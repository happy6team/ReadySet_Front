<template>
    <div class="admin-dashboard">
      ...
      <div class="match-section">
        ...
        <div class="match-controls">
          ...
          <button @click="matchEmployees" class="match-button">신입사원 매칭하기</button>
        </div>
      </div>
      ...
      <div class="dashboard-sections" v-if="matchedEmployees.length">
        <div class="dashboard-section full-width">
          <div class="section-header">
            <h3>매칭 결과 🎯</h3>
            <span class="result-counter">{{ currentIndex + 1 }} / {{ matchedEmployees.length }}</span>
          </div>
  
          <div class="employee-card">
            <div class="employee-header">
              <div class="employee-profile">
                <div class="profile-initial">{{ getInitial(currentEmployee.name) }}</div>
              </div>
            ...
            <div class="employee-content">
              <div class="employee-details">
                <div class="detail-row">
                  ...
                  <div class="detail-value">{{ currentEmployee.personality }}</div>
                </div>
                <div class="detail-row">
              ...
              <div class="navigation-controls">
                <button @click="prevEmployee" :disabled="currentIndex === 0" class="nav-button prev">
                  ← 이전
                </button>
                <button @click="nextEmployee" :disabled="currentIndex === matchedEmployees.length - 1" class="nav-button next">
                  다음 →
                </button>
              </div>
            </div>
      ...
      <div class="dashboard-sections" v-else>
        <div class="dashboard-section full-width">
          <div class="empty-state">
            <img src="https://via.placeholder.com/120?text=📄" alt="매칭 시작" class="empty-icon" />
            <p class="info-text">부서를 선택하고 매칭을 시작해보세요.</p>
            <p class="info-desc">부서 특성과 신입사원의 역량을 고려한 최적의 매칭 결과를 확인할 수 있습니다.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  // 현재 신입사원 정보
  const currentEmployee = computed(() => matchedEmployees.value[currentIndex.value] || {})
      ...
      'AI 개발팀': [
        {
          ...
          reason: '딥러닝 프로젝트 경험이 풍부하고 희망 부서와 일치함. 꼼꼼한 성격으로 AI 모델 검증에 적합함.'
        },
        {
          name: '박준호',
          major: '인공지능학',
          ...
          reason: '스마트팜 관련 AI 프로젝트 경험이 있어 도메인 이해도가 높고, 연구 역량이 뛰어남.'
        },
        {
          name: '이소현',
          major: '데이터사이언스',
          ...
          reason: 'AI 모델 개발과 데이터 처리 능력이 뛰어나 생육 환경 최적화 알고리즘 개발에 적합함.'
        }
      ],
      '데이터 분석팀': [
        {
          ...
          reason: '공정 데이터 분석 경험이 있어 스마트팜 데이터 분석에 바로 투입 가능함.'
        },
        {
          name: '최유진',
          major: '통계학',
          ...
          reason: '농업 데이터 분석 경험이 있어 도메인 지식이 있으며, 뛰어난 통계 역량 보유.'
        }
      ],
      '백엔드 팀': [
        {
          ...
          reason: '백엔드 개발 경험이 풍부하며 MSA 아키텍처 지식이 있어 확장 가능한 시스템 구축에 적합함.'
        },
        {
          name: '정민우',
          major: '컴퓨터공학',
          ...
          reason: '클라우드 서비스 경험이 있어 스마트팜 시스템의 안정적인 운영에 기여할 수 있음.'
        }
      ],
      '프론트엔드 팀': [
        {
        ...
        },
        {
          ...
          reason: 'UX 디자인 경험으로 사용자 친화적인 인터페이스 개발에 기여할 수 있음.'
        }
      ],
      '스마트팜 운영팀': [
        {
        ...
        },
        {
          ...
          reason: '환경 센서 경험이 있어 스마트팜 운영에 필요한 데이터 수집 체계 구축에 도움이 됨.'
        }
      ],
      'IoT 센서팀': [
        {
          ...
          reason: '센서 네트워크 개발 경험이 있어 스마트팜 센서 시스템 구축에 즉시 기여 가능함.'
        },
        {
          name: '임정훈',
          major: '임베디드시스템',
          ...
          reason: '저전력 센서 네트워크 설계 경험으로 효율적인 모니터링 시스템 구축에 적합함.'
        }
      ]
    }
